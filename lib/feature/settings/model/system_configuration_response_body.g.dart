...
SystemConfigurationResponseBody _$SystemConfigurationResponseBodyFromJson(
  ...
  channelWidth: (json['persist.tesla-android.softap.channel_width'] as num)
      .toInt(),
  isEnabledFlag: (json['persist.tesla-android.softap.is_enabled'] as num)
      .toInt(),
  isOfflineModeEnabledFlag:
      (json['persist.tesla-android.offline-mode.is_enabled'] as num).toInt(),
  isOfflineModeTelemetryEnabledFlag:
      (json['persist.tesla-android.offline-mode.telemetry.is_enabled'] as num)
          .toInt(),
  ...
  browserAudioIsEnabled:
      ...
      1,
  browserAudioVolume:
      (json['persist.tesla-android.browser_audio.volume'] as num?)?.toInt() ??
      100,
  isGPSEnabled:
