...
import 'package:tesla_android/feature/connectivityCheck/cubit/connectivity_check_cubit.dart'
    as _i24;
import 'package:tesla_android/feature/display/cubit/display_cubit.dart' as _i22;
import 'package:tesla_android/feature/display/repository/display_repository.dart'
    as _i18;
import 'package:tesla_android/feature/home/cubit/ota_update_cubit.dart' as _i26;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i19.GPSConfigurationCubit>(() =>
        _i19.GPSConfigurationCubit(gh<_i15.SystemConfigurationRepository>()));
    gh.factory<_i20.AudioConfigurationCubit>(() =>
        _i20.AudioConfigurationCubit(gh<_i15.SystemConfigurationRepository>()));
    gh.factory<_i21.DeviceInfoRepository>(
        () => _i21.DeviceInfoRepository(gh<_i12.DeviceInfoService>()));
    gh.factory<_i22.DisplayCubit>(() => _i22.DisplayCubit(
          gh<_i18.DisplayRepository>(),
          gh<_i6.Flavor>(),
        ));
    gh.factory<_i23.ReleaseNotesCubit>(
        () => _i23.ReleaseNotesCubit(gh<_i5.ReleaseNotesRepository>()));
    gh.factory<_i24.ConnectivityCheckCubit>(
        () => _i24.ConnectivityCheckCubit(gh<_i11.HealthService>()));
    gh.factory<_i25.DisplayConfigurationCubit>(
        () => _i25.DisplayConfigurationCubit(gh<_i18.DisplayRepository>()));
    gh.factory<_i26.OTAUpdateCubit>(() => _i26.OTAUpdateCubit(
          gh<_i17.GitHubReleaseRepository>(),
          gh<_i7.SharedPreferences>(),
        ));
    gh.factory<_i27.DeviceInfoCubit>(
        () => _i27.DeviceInfoCubit(gh<_i21.DeviceInfoRepository>()));
    return this;
  }
}
