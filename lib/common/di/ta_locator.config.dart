...
import 'package:tesla_android/common/di/app_module.dart' as _i14;
import 'package:tesla_android/common/navigation/ta_page_factory.dart' as _i7;
import 'package:tesla_android/feature/audio/cubit/audio_cubit.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.PcmAudioPlayer>(() => _i4.PcmAudioPlayer());
    ...
    gh.singleton<_i8.TouchScreenTransport>(
        _i8.TouchScreenTransport(gh<_i3.Flavor>()));
    gh.singleton<_i9.TouchscreenCubit>(
        _i9.TouchscreenCubit(gh<_i8.TouchScreenTransport>()));
    gh.singleton<_i10.AudioTransport>(_i10.AudioTransport(gh<_i3.Flavor>()));
    ...
    gh.singleton<_i13.AudioCubit>(_i13.AudioCubit(
