...
import 'package:tesla_android/common/di/app_module.dart' as _i29;
import 'package:tesla_android/common/di/network_module.dart' as _i30;
...
import 'package:tesla_android/common/network/configuration_service.dart'
    as _i19;
import 'package:tesla_android/common/network/display_service.dart' as _i21;
...
import 'package:tesla_android/feature/connectivityCheck/cubit/connectivity_check_cubit.dart'
    as _i20;
import 'package:tesla_android/feature/display/cubit/display_cubit.dart' as _i28;
...
import 'package:tesla_android/feature/display/transport/display_transport.dart'
    as _i6;
import 'package:tesla_android/feature/gps/cubit/gps_cubit.dart' as _i22;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i18.AudioCubit>(() => _i18.AudioCubit(
          gh<_i4.AudioTransport>(),
          gh<_i11.PcmAudioPlayer>(),
          gh<_i13.SharedPreferences>(),
        ));
    gh.factory<_i19.ConfigurationService>(() => _i19.ConfigurationService(
          gh<_i5.Dio>(),
          gh<_i7.Flavor>(),
        ));
    gh.singleton<_i20.ConnectivityCheckCubit>(
        _i20.ConnectivityCheckCubit(gh<_i10.HealthService>()));
    gh.factory<_i21.DisplayService>(() => _i21.DisplayService(
          gh<_i5.Dio>(),
          gh<_i7.Flavor>(),
        ));
    ...
    gh.factory<_i23.ReleaseNotesCubit>(
        () => _i23.ReleaseNotesCubit(gh<_i12.ReleaseNotesRepository>()));
    gh.factory<_i24.SystemConfigurationRepository>(() =>
        _i24.SystemConfigurationRepository(gh<_i19.ConfigurationService>()));
    gh.factory<_i25.DisplayRepository>(
        () => _i25.DisplayRepository(gh<_i21.DisplayService>()));
    gh.factory<_i26.SystemConfigurationCubit>(
        () => _i26.SystemConfigurationCubit(
              gh<_i24.SystemConfigurationRepository>(),
