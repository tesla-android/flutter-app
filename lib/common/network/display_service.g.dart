...
class _DisplayService implements DisplayService {
  _DisplayService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<RemoteDisplayState> getDisplayState() async {
    ...
    late RemoteDisplayState _value;
    try {
      _value = RemoteDisplayState.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<dynamic> updateDisplayConfiguration(
    RemoteDisplayState configuration,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
