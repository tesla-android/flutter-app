...
void main() {
  group('SoftApBandType', () {
    ...
    test(
      'matchBandTypeFromConfig returns correct type for 5GHz channel 36',
      () {
        final result = SoftApBandType.matchBandTypeFromConfig(
          band: 2,
          channel: 36,
    ...
    test(
      'matchBandTypeFromConfig returns correct type for 5GHz channel 44',
      () {
        final result = SoftApBandType.matchBandTypeFromConfig(
          band: 2,
          channel: 44,
    ...
    test(
      'matchBandTypeFromConfig returns correct type for 5GHz channel 149',
      () {
        final result = SoftApBandType.matchBandTypeFromConfig(
          band: 2,
          channel: 149,
    ...
    test(
      'matchBandTypeFromConfig returns correct type for 5GHz channel 157',
      () {
        final result = SoftApBandType.matchBandTypeFromConfig(
          band: 2,
          channel: 157,
    ...
    test(
      'matchBandTypeFromConfig defaults to band5GHz36 for unknown channel',
      () {
        final result = SoftApBandType.matchBandTypeFromConfig(
          band: 2,
          channel: 999,
